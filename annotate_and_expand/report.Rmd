...
Annotated categories: **`r ncol(tar_read(categ_matrix1))`**
Annotated categories: **`r ncol(tar_read(categ_matrix2))`**
...
Features in ROWS: **`r nrow(tar_read(annot_matrix1))`**
Features in ROWS: **`r nrow(tar_read(annot_matrix2))`**

Samples+Categs in COLUMNS: **`r ncol(tar_read(annot_matrix1))`**
Samples+Categs in COLUMNS: **`r ncol(tar_read(annot_matrix2))`**
...
Features+Categs in ROWS: **`r nrow(tar_read(expd_matrix1))`**
Features+Categs in ROWS: **`r nrow(tar_read(expd_matrix2))`**

Samples in COLUMNS: **`r ncol(tar_read(expd_matrix1))`**
Samples in COLUMNS: **`r ncol(tar_read(expd_matrix2))`**
